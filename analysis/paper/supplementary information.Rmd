...
data_clean %>%
  ...
  mutate(metric = case_when(
    ...
    metric == "lmd" ~ "Length at Max. Dia. (mm)",
    ...
    metric == "dia_mid" ~ "Dia. at Midpoint (mm)",
    metric == "mass" ~ "Mass (g)",
    metric == "percent_lmd" ~ "Location at Max. Dia. (%)",
    metric == "percent_po_b" ~ "Point of Balance (%)",
    TRUE ~ metric
  )) %>%
  mutate(metric = as.factor(metric)) %>%
  mutate(metric = fct_relevel(metric, c("Length (mm)", "Max. Dia. (mm)", "Length at Max. Dia. (mm)", "Point of Balance (mm)", "Dia. at 10mm (mm)", "Dia. at 50mm (mm)", "Dia. at 100mm (mm)", "Dia. at 150mm (mm)", "Dia. at 200mm (mm)", "Dia. at 250mm (mm)", "Dia. at 300mm (mm)", "Dia. at 800mm (mm)", "Dia. at Midpoint (mm)", "Mass (g)", "Location at Max. Dia. (%)", "Point of Balance (%)"))) %>%
  ...
  facetted_pos_scales(
    y = list(
      ...
      metric == "Length at Max. Dia. (mm)" ~ scale_y_continuous(limits = c(0,3000)),
      ...
      metric == "Location at Max. Dia. (%)" ~ scale_y_continuous(limits = c(0,100)),
